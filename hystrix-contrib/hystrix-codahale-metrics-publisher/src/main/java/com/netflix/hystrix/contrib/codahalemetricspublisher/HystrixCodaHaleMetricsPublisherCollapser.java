...
public class HystrixCodaHaleMetricsPublisherCollapser implements HystrixMetricsPublisherCollapser {
    ...
    public void initialize() {
        ...
        metricRegistry.register(createMetricName("batchSize_percentile_90"), (Gauge<Integer>) () -> metrics.getBatchSizePercentile(90));
        metricRegistry.register(createMetricName("batchSize_percentile_99"), (Gauge<Integer>) () -> metrics.getBatchSizePercentile(99));
        ...
        metricRegistry.register(createMetricName("shardSize_percentile_90"), (Gauge<Integer>) () -> metrics.getShardSizePercentile(90));
        metricRegistry.register(createMetricName("shardSize_percentile_99"), (Gauge<Integer>) () -> metrics.getShardSizePercentile(99));
        metricRegistry.register(createMetricName("shardSize_percentile_995"), (Gauge<Integer>) () -> metrics.getShardSizePercentile(99.5));
        ...
        metricRegistry.register(createMetricName("propertyValue_maxRequestsInBatch"), (Gauge<Number>) () -> properties.maxRequestsInBatch().get());

        metricRegistry.register(createMetricName("propertyValue_timerDelayInMilliseconds"), (Gauge<Number>) () -> properties.timerDelayInMilliseconds().get());
    }
