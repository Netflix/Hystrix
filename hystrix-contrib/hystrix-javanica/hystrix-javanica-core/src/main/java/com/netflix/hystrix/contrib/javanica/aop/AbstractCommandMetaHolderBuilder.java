...
public abstract class AbstractCommandMetaHolderBuilder<T extends MetaHolder<T,V>, V extends MetaHolder.Builder<T,V>> {
	...
	protected AbstractCommandMetaHolderBuilder(V builder, Method collapserMethod, Object obj,Class<?> proxyClass, Object[] args) {
	...
	public T build() {
		AbstractCommandMetaHolderBuilder.HystrixPointcutType type = of(method);
		setFallbackMethod();
	...
	protected  void setFallbackMethod() {
	...
	protected Class<?> getFirstGenericParameter(Type type) {
		return getFirstGenericParameter(type, 1);
	}


	protected Class<?> getFirstGenericParameter(final Type type, final int nestedDepth) {
		int cDepth = 0;
		Type tType = type;
	...
	public enum HystrixPointcutType {
	 ...
	 AbstractCommandMetaHolderBuilder.HystrixPointcutType of(Method method) {
