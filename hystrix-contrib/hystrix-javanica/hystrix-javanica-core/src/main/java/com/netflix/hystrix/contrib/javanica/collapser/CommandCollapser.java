 ...
 */
public class CommandCollapser<T extends MetaHolder<T,V>,V extends MetaHolder.Builder<T,V>> extends HystrixCollapser<List<Object>, Object, Object> {

    private T metaHolder;
     ...
     */
    public  CommandCollapser(AbstractHystrixCommandBuilderFactory<T,V> commandBuilderFactory,T metaHolder) {
        super(commandBuilderFactory.create(metaHolder).getSetterBuilder().buildCollapserCommandSetter());
    ...
    protected HystrixCommand<List<Object>> createCommand(
       ...
       return new BatchHystrixCommand(commandBuilderFactory.create(metaHolder, collapsedRequests));
    }
