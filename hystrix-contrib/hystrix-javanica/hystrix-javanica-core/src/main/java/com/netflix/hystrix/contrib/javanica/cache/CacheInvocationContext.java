...
public class CacheInvocationContext<A extends Annotation> {
    ...
    private final CommandAction cacheKeyMethod;
     ...
     */
    public CacheInvocationContext(A cacheAnnotation, CommandAction action, Object target, Method method, Object... args) {
        this.method = method;
        this.target = target;
        this.cacheKeyMethod = action;
    ...
    public String getCacheKeyMethodName() {
        return cacheKeyMethod != null ? cacheKeyMethod.getMetaHolder().getMethod().getName() : null;
    }
     ...
     */
    public CommandAction getCacheKeyMethod() {
