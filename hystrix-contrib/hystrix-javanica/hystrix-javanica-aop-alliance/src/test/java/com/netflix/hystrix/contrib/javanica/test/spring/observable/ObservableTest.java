...
import com.netflix.hystrix.contrib.javanica.test.spring.observable.ObservableTest.ObservableTestConfig;
...
@ContextConfiguration(classes = {AopCglibConfig.class, ObservableTestConfig.class})
