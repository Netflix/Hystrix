 ...
 */
package com.netflix.hystrix.contrib.javanica.test.guice.command;
...
public class CommandTest extends BasicCommandTest {
    ...
    public static void setup() {
        injector = getBaseInjector().createChildInjector(new AbstractModule() {
            ...
            protected void configure() {
                ...
                bind(AdvancedUserService.class);
                bind(GenericUserService.class);
    ...
    protected BasicCommandTest.AdvancedUserService createAdvancedUserServiceService() {
        return injector.getInstance(AdvancedUserService.class);
    }

    @Override
    protected BasicCommandTest.GenericService<String, Long, User> createGenericUserService() {
        return injector.getInstance(GenericUserService.class);
    }
