...
import com.netflix.hystrix.contrib.javanica.test.spring.collapser.CollapserTest.CollapserTestConfig;
...
@ContextConfiguration(classes = {AopCglibConfig.class, CollapserTestConfig.class})
