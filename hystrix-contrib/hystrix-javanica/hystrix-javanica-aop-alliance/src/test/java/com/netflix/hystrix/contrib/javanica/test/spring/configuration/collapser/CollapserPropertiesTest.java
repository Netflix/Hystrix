...
import com.netflix.hystrix.contrib.javanica.test.spring.configuration.collapser.CollapserPropertiesTest.CollapserPropertiesTestConfig;
...
@ContextConfiguration(classes = {AopCglibConfig.class, CollapserPropertiesTestConfig.class})
