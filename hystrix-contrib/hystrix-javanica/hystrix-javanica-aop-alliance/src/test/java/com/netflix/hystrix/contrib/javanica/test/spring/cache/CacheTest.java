...
import com.netflix.hystrix.contrib.javanica.test.spring.cache.CacheTest.CacheTestConfig;
...
@ContextConfiguration(classes = {AopCglibConfig.class, CacheTestConfig.class})
