...
import com.netflix.hystrix.contrib.javanica.aop.aopalliance.BeanFactory;
import com.netflix.hystrix.contrib.javanica.aop.aopalliance.BeanFactory.Type;
import com.netflix.hystrix.contrib.javanica.cache.HystrixCacheKeyGeneratorTest;

/**
 * @author justinjose28
 * 
 */
public class AopAllianceCacheKeyGeneratorTest extends HystrixCacheKeyGeneratorTest<AopAllianceMetaHolder, AopAllianceMetaHolder.Builder> {
	...
	protected AbstractCacheInvocationContextFactory<AopAllianceMetaHolder, AopAllianceMetaHolder.Builder> getCacheInvocationContextFactory() {
		return BeanFactory.getCacheInvocationContextFactory(Type.DEFAULT);
	}
