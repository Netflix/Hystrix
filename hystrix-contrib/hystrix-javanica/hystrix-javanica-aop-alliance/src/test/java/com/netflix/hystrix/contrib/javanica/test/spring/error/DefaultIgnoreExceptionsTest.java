...
import com.netflix.hystrix.contrib.javanica.test.spring.error.DefaultIgnoreExceptionsTest.DefaultIgnoreExceptionsTestConfig;
...
@ContextConfiguration(classes = {AopCglibConfig.class, DefaultIgnoreExceptionsTestConfig.class})
