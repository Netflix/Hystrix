...
import com.netflix.hystrix.contrib.javanica.test.spring.error.DefaultRaiseHystrixExceptionsTest.DefaultRaiseHystrixExceptionsTestConfig;
...
@ContextConfiguration(classes = {AopCglibConfig.class, DefaultRaiseHystrixExceptionsTestConfig.class})
