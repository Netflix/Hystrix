...
public class DefaultFallbackTest extends BasicDefaultFallbackTest {
    ...
    public static void setup() {
        ...
        bind(serv, new AbstractBinder() {
            ...
            protected void configure() {
                bindAsContract(ServiceWithDefaultFallback.class).in(PerLookup.class);
                bindAsContract(ServiceWithDefaultCommandFallback.class).in(PerLookup.class);
    ...
    protected ServiceWithDefaultFallback createServiceWithDefaultFallback() {
        return serv.getService(ServiceWithDefaultFallback.class);
    }

    @Override
    protected ServiceWithDefaultCommandFallback serviceWithDefaultCommandFallback() {
        return serv.getService(ServiceWithDefaultCommandFallback.class);
    }
