...
import com.netflix.hystrix.contrib.javanica.test.spring.configuration.command.CommandPropertiesTest.CommandPropertiesTestConfig;
...
@ContextConfiguration(classes = {AopCglibConfig.class, CommandPropertiesTestConfig.class})
