...
import com.netflix.hystrix.contrib.javanica.test.spring.error.ObservableErrorPropagationTest.ErrorPropagationTestConfig;
...
@ContextConfiguration(classes = {AopCglibConfig.class, ErrorPropagationTestConfig.class})
