 ...
 * 
 */
public class SpringAopAllianceCommandBuilderFactory extends AopAllianceCommandBuilderFactory {

	public SpringAopAllianceCommandBuilderFactory(AbstractCacheInvocationContextFactory<AopAllianceMetaHolder, Builder> cacheInvocationContextFactory) {
	...
	protected AopAllianceMethodExecutionAction getMethodExecutionAction(AopAllianceMetaHolder metaHolder) {
		return new SpringMethodExecutionAction(metaHolder);
	}
