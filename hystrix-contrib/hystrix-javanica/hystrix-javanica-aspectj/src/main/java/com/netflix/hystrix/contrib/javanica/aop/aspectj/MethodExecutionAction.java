...
public class MethodExecutionAction implements CommandAction {
    ...
    private final AspectjMetaHolder metaHolder;


    public MethodExecutionAction(Object object, Method method, AspectjMetaHolder metaHolder) {
        this.object = object;
        this.method = method;
    ...
    public MethodExecutionAction(Object object, Method method, Object[] args, AspectjMetaHolder metaHolder){
        this.object = object;
        this.method = method;
        this._args = args;
        this.metaHolder = metaHolder;
