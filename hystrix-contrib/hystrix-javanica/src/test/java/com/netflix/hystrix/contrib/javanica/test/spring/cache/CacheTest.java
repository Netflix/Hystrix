...
public class CacheTest {
    ...
    public void testGetUserCache() {
        ...
        try {
            ...
            com.netflix.hystrix.HystrixCommand<?> getUserByIdCommand = getLastExecutedCommand();
    ...
    private com.netflix.hystrix.HystrixCommand<?> getLastExecutedCommand() {
        Collection<com.netflix.hystrix.HystrixCommand<?>> executedCommands =
