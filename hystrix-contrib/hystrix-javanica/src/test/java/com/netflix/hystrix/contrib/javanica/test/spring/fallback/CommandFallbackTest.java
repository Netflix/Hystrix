...
public class CommandFallbackTest {
    ...
    public void testGetUserAsyncWithFallback() throws ExecutionException, InterruptedException {
        ...
        try {
            ...
            com.netflix.hystrix.HystrixCommand<?> command = HystrixRequestLog.getCurrentRequest()
                    .getExecutedCommands().iterator().next();
    ...
    public void testGetUserAsyncWithFallbackCommand() throws ExecutionException, InterruptedException {
        ...
        try {
            ...
            com.netflix.hystrix.HystrixCommand<?> getUserAsyncFallbackCommand = getHystrixCommandByKey(
    ...
    public void testGetUserSyncWithFallbackCommand() {
        ...
        try {
            ...
            assertEquals("def", u1.getName());
            assertEquals(3, HystrixRequestLog.getCurrentRequest().getExecutedCommands().size());
            com.netflix.hystrix.HystrixCommand<?> getUserSyncFallbackCommand = getHystrixCommandByKey(
