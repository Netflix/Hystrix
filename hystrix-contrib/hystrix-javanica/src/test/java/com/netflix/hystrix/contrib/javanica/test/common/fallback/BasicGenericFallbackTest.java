...
public abstract class BasicGenericFallbackTest extends BasicHystrixTest {
    ...
    public static class MethodGenericDefinitionSuccessCase1 {
        ...
        @HystrixCommand(fallbackMethod = "fallback")
        public <T extends Serializable> T command() {
            throw new IllegalStateException();
        }

        private <T extends Serializable> T fallback() {
            return null;
        }
    }
    ...
    public static class MethodGenericDefinitionSuccessCase2 {
        ...
        @HystrixCommand(fallbackMethod = "fallback")
        public <T extends Serializable, T1 extends T> T1 command() {
            throw new IllegalStateException();
        }

        private <T extends Serializable, T1 extends T> T1 fallback() {
            return null;
        }
    }
    ...
    public static class MethodGenericDefinitionSuccessCase3 {
        ...
        @HystrixCommand(fallbackMethod = "fallback")
        public <T extends Serializable, T1 extends T> GenericEntity<? extends T1> command() {
            throw new IllegalStateException();
        }

        private <T extends Serializable, T1 extends T> GenericEntity<? extends T1> fallback() {
            return null;
        }
    }
    ...
    public static class MethodGenericDefinitionSuccessCase4 {
        ...
        @HystrixCommand(fallbackMethod = "fallback")
        public <T extends Serializable & Comparable, T1 extends T> GenericEntity<? extends T1> command() {
            throw new IllegalStateException();
        }

        private <T extends Serializable & Comparable, T1 extends T> GenericEntity<? extends T1> fallback() {
            return null;
        }
    }
    ...
    public static class MethodGenericDefinitionSuccessCase5 {
        ...
        @HystrixCommand(fallbackMethod = "fallback")
        public <T extends Serializable & Comparable, T1 extends GenericEntity<T>> GenericEntity<T1> command() {
            throw new IllegalStateException();
        }

        private <T extends Serializable & Comparable, T1 extends GenericEntity<T>> GenericEntity<T1> fallback() {
            return null;
        }
    }
    ...
    public static class MethodGenericDefinitionSuccessCase6 {
        ...
        @HystrixCommand(fallbackMethod = "fallback")
        public <T> GenericEntity<T> command() {
            throw new IllegalStateException();
        }

        private <T> GenericEntity<T> fallback() {
            return new GenericEntity<T>();
        }
    }
    ...
    public static class MethodGenericDefinitionSuccessCase7 {
        ...
        @HystrixCommand(fallbackMethod = "fallback")
        public GenericEntity<? super Serializable> command() {
            throw new IllegalStateException();
        }

        private GenericEntity<? super Serializable> fallback() {
            return null;
        }
    }
    ...
    public static class MethodGenericDefinitionFailureCase2 {
        ...
        private <T extends Comparable> T fallback() {
            return null;
        }
    }
    ...
    public static class MethodGenericDefinitionFailureCase3 {
        ...
        private <T extends Serializable, T1 extends T> GenericEntity<T1> fallback() {
            return null;
        }
    }
    ...
    public static class MethodGenericDefinitionFailureCase5 {
        ...
        private <T extends Serializable & Comparable, T1 extends GenericEntity<String>> GenericEntity<T1> fallback() {
            return null;
        }
    }
    ...
    public static class MethodGenericDefinitionFailureCase6 {
        ...
        private GenericEntity<String> fallback() {
    ...
    public static class MethodGenericDefinitionFailureCase7 {
        ...
        @HystrixCommand(fallbackMethod = "fallback")
        public <T> Set<T> command() {
            throw new IllegalStateException();
        }

        private <T> List<T> fallback() {
            return null;
        }
    }
    ...
    public static class MethodGenericDefinitionFailureCase8 {
        ...
        @HystrixCommand(fallbackMethod = "fallback")
        public <T> GenericEntity<Set<T>> command() {
            throw new IllegalStateException();
        }

        private <T> GenericEntity<List<T>> fallback() {
            return null;
        }
    }
    ...
    public static class MethodGenericDefinitionFailureCase9 {
        ...
        @HystrixCommand(fallbackMethod = "fallback")
        public <T> GenericEntity<List<Set<T>>> command() {
            throw new IllegalStateException();
        }

        private <T> GenericEntity<List<List<T>>> fallback() {
            return null;
        }
    }
    ...
    public static class ClassGenericDefinitionSuccessCase0<T> {
        ...
        @HystrixCommand(fallbackMethod = "fallback")
        public GenericEntity<T> command() {
            throw new IllegalStateException();
        }

        private GenericEntity<T> fallback() {
            return new GenericEntity<T>();
        }
    }
    ...
    public static class ClassGenericDefinitionFailureCase1<T extends Serializable> {
        ...
        private <T extends Serializable> GenericEntity<T> fallback() {
            return new GenericEntity<T>();
        }
    }
