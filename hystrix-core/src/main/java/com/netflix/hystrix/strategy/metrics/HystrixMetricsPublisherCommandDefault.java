...
/**
 * Default implementation of {@link HystrixMetricsPublisherCommand} using Servo (https://github.com/Netflix/servo)
 * 
 * @ExcludeFromJavadoc
 */
public class HystrixMetricsPublisherCommandDefault implements HystrixMetricsPublisherCommand {
    ...
    public void initialize(HystrixCommandKey commandKey, HystrixCommandGroupKey commandGroupKey, HystrixCommandMetrics metrics, HystrixCircuitBreaker circuitBreaker, HystrixCommandProperties properties) {
        CommandMetricsPublisher publisher = new CommandMetricsPublisher(commandKey, commandGroupKey, metrics, circuitBreaker, properties);
        /* list of monitors */
        List<Monitor<?>> monitors = publisher.getServoMonitors();
    ...
    private static class CommandMetricsPublisher extends HystrixMetricsServoPublisherAbstract {
        ...
        public CommandMetricsPublisher(HystrixCommandKey commandKey, HystrixCommandGroupKey commandGroupKey, HystrixCommandMetrics metrics, HystrixCircuitBreaker circuitBreaker, HystrixCommandProperties properties) {
            this.key = commandKey;
