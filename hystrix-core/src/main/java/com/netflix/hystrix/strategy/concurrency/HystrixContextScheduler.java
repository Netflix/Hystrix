...
public class HystrixContextScheduler extends Scheduler {
    ...
    private class InnerHystrixContextScheduler extends Inner {
        ...
        public void schedule(Action1<Inner> action, long delayTime, TimeUnit unit) {
            ...
            actualScheduler.schedule(new HystrixContextSchedulerAction(concurrencyStrategy, action), delayTime, unit);
        }
        ...
        public void schedule(Action1<Inner> action) {
            ...
            actualScheduler.schedule(new HystrixContextSchedulerAction(concurrencyStrategy, action));
        }
    ...
    public static class HystrixContextInnerScheduler extends Inner {
        ...
        @Override
        public void schedule(Action1<Inner> action, long delayTime, TimeUnit unit) {
            actual.schedule(new HystrixContextSchedulerAction(concurrencyStrategy, action), delayTime, unit);
        }

        @Override
        public void schedule(Action1<Inner> action) {
            actual.schedule(new HystrixContextSchedulerAction(concurrencyStrategy, action));
        }
