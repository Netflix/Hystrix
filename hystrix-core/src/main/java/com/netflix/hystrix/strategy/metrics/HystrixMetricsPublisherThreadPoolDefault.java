...
public class HystrixMetricsPublisherThreadPoolDefault implements HystrixMetricsPublisherThreadPool {
    ...
    public void initialize(HystrixThreadPoolKey threadPoolKey, HystrixThreadPoolMetrics metrics, HystrixThreadPoolProperties properties) {
        ThreadPoolMetricsPublisher publisher = new ThreadPoolMetricsPublisher(threadPoolKey, metrics, properties);
        /* list of monitors */
        ...
        MonitorConfig commandMetricsConfig = MonitorConfig.builder("HystrixThreadPool_" + threadPoolKey.name()).build();
    ...
    private static class ThreadPoolMetricsPublisher extends HystrixMetricsServoPublisherAbstract {
        ...
        public ThreadPoolMetricsPublisher(HystrixThreadPoolKey threadPoolKey, HystrixThreadPoolMetrics metrics, HystrixThreadPoolProperties properties) {
