...
public interface HystrixCommandKey extends HystrixKey {
    ...
    class Factory {
        ...
        private static final InternMap<String, HystrixCommandKeyDefault> intern = new InternMap<String, HystrixCommandKeyDefault>(new InternMap.ValueConstructor<String, HystrixCommandKeyDefault>() {
